      ...
      <div className="flex w-full flex-col border-b border-gray-800 p-6 text-zinc-400 sm:w-1/2 sm:border-b-0 sm:border-r">
        <div className="py-6">
          ...
          <p className="text-base font-normal leading-6">
            Sou um desenvolvedor web e mobile. Tenho experiência na criação de
            soluções eficientes e intuitivas, utilizando tecnologias como
